...
o3 = pd.read_csv(epa_direc + 'epa_aqs_data_O3.csv')
...
data = pd.concat([data, pm_data, pm10_data, o3_data, no2_data, co_data], axis = 1)
...
data = pd.concat([data, rnr_pm_data_30, rnr_pm10_data_30, rnr_o3_data_30, rnr_no2_data_30, rnr_co_data_30,
                  rnr_pm_data_60, rnr_pm10_data_60, rnr_o3_data_60, rnr_no2_data_60, rnr_co_data_60, 
                  rnr_pm_data_90, rnr_pm10_data_90, rnr_o3_data_90, rnr_no2_data_90, rnr_co_data_90,
                  rnr_pm_data_180, rnr_pm10_data_180, rnr_o3_data_180, rnr_no2_data_180, rnr_co_data_180], axis = 1)
